...
const ko: Translations = {
  ...
  validation: {
    ...
    maxIngredients: "___Cannot have more than 40 ingredients in total",
    maxIngredientSections: "___Cannot have more than 20 ingredient sections",
    sectionTitleMaxLength: "___Section title cannot exceed 255 characters",
  ...
  recipeAddOptionsScreen: {
    ...
    optionFromVoice: "___Add Recipe by Speaking",
    optionFromVoiceDesc: "___Describe your recipe out loud and we'll build it",
    optionFromTiktok: "___Import from TikTok",
    optionFromTiktokDesc: "___Paste a link to a TikTok recipe video",
    optionFromInstagram: "___Import from Instagram",
  ...
  recipeAddSocialImportScreen: {
    ...
    validation: {
      ...
      mustBeValidUrl: "___Please enter a valid URL",
    },
  },
  recipeAddVoiceScreen: {
    title: "___Speak Your Recipe",
    tapToStart: "___Tap the microphone to start",
    listening: "___Listening...",
    processing: "___Building your recipe",
    stopButton: "___Done — Review Transcript",
    cancelButton: "___Cancel",
    startButton: "___Start Listening",
    transcriptLabel: "___What we heard:",
    editTranscript: "___Edit the transcript if needed, then build your recipe.",
    reviewTitle: "___Review Transcript",
    processButton: "___Build Recipe",
    reRecordButton: "___Re-record",
  ...
  recipeFormScreen: {
    ...
    ingredientSectionTitleLabel: "___Section title (optional)",
    ingredientSectionTitlePlaceholder: "___e.g. For the sauce",
  ...
  membershipScreen: {
    ...
    tier: {
      owner: "___Owner",
      admin: "___Admin",
      contributor: "___Contributor",
      viewer: "___Viewer",
    },
    tierDescription: {
      owner:
        "___Full control. Transfer ownership, manage all members, edit cookbook details, and all recipes.",
      admin: "___Manage members below admin, edit cookbook details, and all recipes.",
      contributor: "___Add recipes and send invites. Edit or delete only your own recipes.",
      viewer: "___View recipes only. Cannot add, edit, invite, or manage members.",
    },
    editMemberSubtitle: "___Choose a role for this member.",
    editMemberFallback: "___Member",
    roleSectionTitle: "___Role",
