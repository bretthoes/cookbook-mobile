const en = {
  ...
  validation: {
    ...
    maxIngredients: "Cannot have more than 40 ingredients in total",
    maxIngredientSections: "Cannot have more than 20 ingredient sections",
    sectionTitleMaxLength: "Section title cannot exceed 255 characters",
  ...
  recipeAddOptionsScreen: {
    ...
    optionFromVoice: "Add Recipe by Speaking",
    optionFromVoiceDesc: "Describe your recipe out loud and we'll build it",
    optionFromTiktok: "Import from TikTok",
    optionFromTiktokDesc: "Paste a link to a TikTok recipe video",
    optionFromInstagram: "Import from Instagram",
    ...
    proUnlimitedLabel: "Pro — Unlimited imports",
    weeklyUsageLabel: "{{used}} / {{limit}} imports used this week",
    weeklyLimitReachedTitle: "Weekly Limit Reached",
    weeklyLimitReachedMessage:
      "You've used all {{limit}} free imports for this week. Upgrade to Pro for unlimited imports, or come back next Monday.",
  ...
  recipeAddVoiceScreen: {
    ...
    stopButton: "Done — Review Transcript",
    cancelButton: "Cancel",
    startButton: "Start Listening",
    transcriptLabel: "What we heard:",
    editTranscript: "Edit the transcript if needed, then build your recipe.",
    reviewTitle: "Review Transcript",
    processButton: "Build Recipe",
  ...
  recipeAddPhotoScreen: {
    ...
    subtitle: "Choose a photo of a recipe to import.",
    processing: "Reading your recipe",
    choosePhoto: "Choose Photo",
    errorTitle: "Couldn't read that photo",
    parseFailed: "Couldn't build a recipe from that photo. Try a clearer image of the recipe text.",
    rateLimited: "The AI service is temporarily unavailable. Please try again later.",
    takePhoto: "Take a Photo",
    selectFromRoll: "Select from Camera Roll",
    cameraRollPermissionDenied: "Camera roll access is required. Please allow it in your device settings.",
    cameraPermissionDenied: "Camera access is required. Please allow it in your device settings.",
  },
  ...
  recipeAiEditDialog: {
    title: "Edit with AI",
    subtitle: "Describe the changes you want — type or speak your instruction.",
    placeholder: "e.g. Double the garlic, mark as vegan, add a dessert tag…",
    applyButton: "Apply Changes",
    cancelButton: "Cancel",
    processing: "Applying your changes…",
    parseFailed: "Couldn't apply that change. Try rephrasing your instruction.",
    rateLimited: "The AI service is temporarily unavailable. Please try again later.",
    microphonePermissionDenied:
      "Microphone access is required. Please allow it in your device settings.",
    unknownError: "Something went wrong. Please try again.",
    ...
    fabAccessibilityLabel: "Edit recipe with AI",
  },
  recipeSummary: {
    showMore: "Show More...",
    showLess: "Show Less...",
  ...
  recipeFormScreen: {
    ...
    ingredientSectionTitleLabel: "Section title (optional)",
    ingredientSectionTitlePlaceholder: "e.g. For the sauce",
  ...
  membershipScreen: {
    ...
    editMemberSubtitle: "Choose a role for this member.",
    editMemberFallback: "Member",
  ...
  languageScreen: {
    ...
    support: "Don't see your language? You can request support for a new language.",
  },
  paywallScreen: {
