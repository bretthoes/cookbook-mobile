...
export function Toggle<T>(props: ToggleProps<T>) {
  ...
  const $containerStyles: StyleProp<ViewStyle> = [$containerStyleOverride]
  const $inputWrapperStyles: StyleProp<ViewStyle> = [
    $styles.row,
    $inputWrapper,
    $inputWrapperStyleOverride,
  ]
  const $helperStyles: StyleProp<TextStyle> = themed([
    $helper,
...
function FieldLabel<T>(props: ToggleProps<T>) {
  ...
  const $labelStyle: StyleProp<TextStyle> = themed([
    $label,
    status === "error" && { color: colors.error },
